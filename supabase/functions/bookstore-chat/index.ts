    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `You are a helpful bookstore assistant for BookNest. Answer questions about:
- Book recommendations based on genres (Fiction, Non-Fiction, Mystery, Romance, Sci-Fi)
- How to browse and search for books
- How to add books to cart or wishlist
